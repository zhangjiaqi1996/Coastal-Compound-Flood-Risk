...
gdf = gpd.read_file("/public/home/jiaqizhang/JiaqiZhang/data-doctor3/2.reanalysis/1.data/10.tidalflat/gridnet_tidalflats.shp",engine="pyogrio")##################################modify here
...
tiff_file = '/public/home/jiaqizhang/JiaqiZhang/data-doctor3/population/ppp_2010_1km_Aggregated.tif'##################################modify here
...
flood_stats.rename(columns={'sum': 'population'}, inplace=True)##################################modify here
...
flood_stats.to_file('/public/home/jiaqizhang/JiaqiZhang/data-doctor3/2.reanalysis/1.data/10.tidalflat/gridnet_tidalflats_pop.shp', driver='ESRI Shapefile')##################################modify here
flood_stats.to_excel('/public/home/jiaqizhang/JiaqiZhang/data-doctor3/2.reanalysis/1.data/10.tidalflat/gridnet_tidalflats_pop.xlsx', index=False)
